...
- Current public beta context at this writing: `0.49.5` focused on sturdier
  Settings UX, widget editor polish, clipboard controls inside the Clipboard
  widget editor, always-on-top fixes, and text encoding checks.
...
- `release.yml` publishes from tags like `v0.49.5`.
